...
<body>
						...
						<div class="col-md-4 mt-3">
							<div class="card">
								...
								<div class="card-body">
									...
									<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-<?php echo $produto->id; ?>">Comprar</button>
								</div>
							</div>
						</div>
					<?php } ?>
	...
	<?php foreach($produtos as $chave => $produto): ?>
		...
		<div class="modal fade" id="modal-<?php echo $produto->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					...
					<div class="modal-body">
						<div class="form-group">
							<form method="POST" action="sucesso.php">
								<input type="text" name="produto_id" value="<?php echo $produto->id;?>" hidden>
								<div class="form-group">
